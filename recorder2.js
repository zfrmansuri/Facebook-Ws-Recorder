...
(async () => {
    ...
    async function attachToPage(page) {
        ...
        cdp.on(
            ...
            event => {
                ...
                // -----------------------------------------
                // UNTRACKED / OTHER WEBSOCKET
                // -----------------------------------------
                //
                // Small untracked frames are ignored.
                //
                // IMPORTANT:
                // A large frame must NOT disappear simply
                // because its socket isn't mapped to the
                ...
                if (
                    ...
                    const unknownLower =
                        unknownDecodedText.toLowerCase();


                    const unknownMatchedIndicators =
                        INDICATORS.filter(
                            indicator =>
                                unknownLower.includes(
                                    indicator
                                )
                        );
                    ...
                    console.log(
                        "🔥 LARGE UNTRACKED WEBSOCKET FRAME"
                    );
                    ...
                    console.log(
                        `Raw payload: ${Buffer.byteLength(decoded.rawPayload)} bytes`
                    );
                    ...
                    if (
                        unknownMatchedIndicators.length > 0
                    ) {

                        console.log(
                            `🔎 Indicators: ${unknownMatchedIndicators.join(", ")}`
                        );
    ...
    console.log(
        "Large untracked frames:"
    );

    console.log(
        "  💾 SAVING to unknown-large/"
    );
